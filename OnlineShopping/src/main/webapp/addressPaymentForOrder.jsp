...
<div class="right-div">
<h3>Pay online on this smartPay@pay.com</h3>
...
<div class="left-div">
<h3>Mobile Number</h3>
<input class="input-style" type="text" name="mnumber" value="<%=rs2.getString(3)%>" placeholder="Enter Mobile Number" required>
